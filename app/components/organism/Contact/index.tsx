...
const Index = () => {
  ...
  const handleSubmit = (e: { preventDefault: () => void }) => {
    ...
    if (!name || !email || !message) {
      ...
      try {
        fetch(
          "https://wanergeav.app.n8n.cloud/webhook/f79dcef8-8e1d-424e-83ef-72d768fdb252",
          {
            method: "POST",
            headers: {
  ...
  return (
    <div>
      <section className="min-h-screen bg-linear-to-r from-primary via-secondary to-blanco ">
              ...
              <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl lg:max-w-xl">
                ...
                <form className="mt-4">
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-primary rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50"
                  >
                    get in touch
                  </button>
                </form>
